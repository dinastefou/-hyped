...
$(function(){
    ...
    if (viewPortWidth <800) {
            ...
            var heightPercentage = (viewPortHeight * 100) / 600;
            var widthPercentage = (viewPortWidth * 100) / 900;
            var percentage = Math.min(heightPercentage, widthPercentage);
            var newFontSize = percentage.toFixed(2);
            var newTsize = 2 + percentage.toFixed(2);

            document.getElementById("slide8").style.fontSize = newFontSize + '%';
            document.getElementById("slide9").style.fontSize = newFontSize + '%';
            document.getElementById("slide10").style.fontSize = newFontSize + '%';
            document.getElementById("tgal").style.fontSize = newTsize + '%';
            document.getElementById("tabout").style.fontSize = newTsize + '%';
            document.getElementById("tcast").style.fontSize = newTsize + '%';
            document.getElementById("tHyped").style.fontSize = newTsize + '%';
            document.getElementById("pHyped").style.fontSize = newFontSize + '%';
            
            $('#section3').addClass('noarrow');
            $('#section1').addClass('noarrow');
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        function resizeMe(displayHeight, displayWidth) {
            ...
            var preferredHeight = 510;
            var preferredWidth = 860;
            ...
            if (displayHeight < preferredHeight || displayWidth < preferredWidth) {
                ...
                $(".slide").css('font-size', (newFontSize / (5/4)) + '%');
            } else {
